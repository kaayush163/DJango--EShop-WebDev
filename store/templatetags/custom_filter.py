...
@register.filter(name='multiply')  #when we use in template then it is called in the below fucntion according matching name this is is use of decrator
def multiply(number,number1):   #cart is the dictionary having key values defiend home.html 
